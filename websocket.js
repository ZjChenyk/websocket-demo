...
(function ($) {
  ...
  NewSocket.prototype.getIp = function () {
    ...
    //     webSocketMsgIp = originThis.opts.socketIp ? originThis.opts.socketIp : data.fuq_url;
        ...
        sockUrl = 'http://' + webSocketMsgIp + originThis.opts.sockUrl;
      // }
    // });
  };
  // 函数：获取url
  ...
  function curTime() {
    ...
    var openTimeSpe = openTime.getFullYear() + '/' + Number(Number(openTime.getMonth()) + 1) + '/' + openTime.getDate() + '，' + openTime.getHours() + ':' + openTime.getMinutes() + ':' + openTime.getSeconds();
    return openTimeSpe;
  }
